function simpleGet() {
    fetch('http://127.0.0.1:8000/api/ajax/get/zitu')
        .then(r => r.text())
        .then(data => {
            console.log(data)
        })
...
function errorCheck() {
    fetch('http://127.0.0.1:8000/api/ajax/getData/1')
        .then(r => {
...
function simpleGetAxios() {
    axios.get("http://127.0.0.1:8000/api/ajax/get/zitu")
        .then(data => {
            console.log(data)
        })
}
...
function postRequestAxios() {
    axios.post('http://127.0.0.1:8000/api/ajax/post', { name: 'zitu' , email: 'zitu094@gmail.com'})
        .then(data => {
            console.log(data.data)
        })
}
